Індивідульне завдання. Аналіз зв'язку медичних показників людини та виникнення хвороби серця.
================

Набір даних
-----------

У завданні було використано набір даних, що містить список медичних показнків, який характеризує наявність хвороби серця від UCI Health.(<https://www.kaggle.com/ronitf/heart-disease-uci>)
